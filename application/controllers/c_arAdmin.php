<?php
class c_arAdmin extends CI_Controller {
	...
	//menu jadwal katu
	function displaydata_pembg_tugas(){
		$data = array (
			'list_menu'=>$this->m_login->tampil_menu(),
			'list_online'=>$this->m_login->tampil_online(),
			'foto' => $this->m_katu->getFoto(),
	...
	function displaydata_presensi(){
		...
		$this->load->view('template',$data);
			...
			function displaydata_penilaian(){
				$data['list_menu'] = $this->m_login->tampil_menu();
				$data['list_online'] = $this->m_login->tampil_online();
				$data['foto'] = $this->m_katu->getFoto();
			...
			function display_rekap_kunjungan(){
				$data['list_menu'] = $this->m_login->tampil_menu();
				$data['list_online'] = $this->m_login->tampil_online();
				$data['foto'] = $this->m_katu->getFoto();
			...
			function display_rekap_peristiwa(){
				$data['list_menu'] = $this->m_login->tampil_menu();
				$data['list_online'] = $this->m_login->tampil_online();
				$data['foto'] = $this->m_katu->getFoto();
			...
			function displayform_input_nama_kebersihan(){
				$data = array (
					'list_menu'=>$this->m_login->tampil_menu(),
					'list_online'=>$this->m_login->tampil_online(),
					'peg' => $this->m_katu->get_pegawai(),
		...
		function displayRekapPengajuan(){
			$data['list_menu'] = $this->m_login->tampil_menu();
			$data['list_online'] = $this->m_login->tampil_online();
			$data['foto'] = $this->m_katu->getFoto();
		...
		function displayHistoryRekapPengajuan(){
			$data['list_menu'] = $this->m_login->tampil_menu();
			$data['list_online'] = $this->m_login->tampil_online();
			$data['foto'] = $this->m_katu->getFoto();
		...
		function displayLaporanKegiatanCar(){
			$data['list_menu'] = $this->m_login->tampil_menu();
			$data['list_online'] = $this->m_login->tampil_online();
			$data['foto'] = $this->m_katu->getFoto();
