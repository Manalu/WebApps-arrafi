	...
	class m_caraka extends CI_Model{
		...
		public function insert_absen($url){
		...
		$this->db->set('tgl_pengajuan',$this->input->post('tgl_pengajuan'));
		...
		public function insertDetailPengajuan($brg,$jml,$ket){
		$dt = $this->getIdpengajuan()->row();
		$this->db->set('id_pengajuan',$dt->id_pengajuan);
