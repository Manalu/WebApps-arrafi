			...
			<div class="panel">
				<div class="panel-body">
					<div class="row">
						<div class="col-sm-6">
							<div class="m-b-30">
								<a href="<?php echo base_url('c_admin/akun_tambah');?>" class="btn btn-default waves-effect waves-light">
									<i class="fa fa-plus"></i> Tambah User
								</a>
							</div>
							<div class="m-b-30">
								<a href="<?php echo base_url('c_admin/grup_user_tambah');?>" class="btn btn-default waves-effect waves-light">
