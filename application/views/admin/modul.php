			...
			<div class="panel">
				<div class="panel-body">
					<div class="row">
						<div class="col-sm-6">
							<div class="m-b-30">
								<a href="<?php echo base_url('c_admin/modul_tambah');?>" class="btn btn-default waves-effect waves-light">
						...
						<table class="table table-striped" id="datatable">
							...
							<?php
								...
								<tr class="gradeX">
	                                ...
	                                <td>
										<?php echo anchor('/c_admin/get_modul/'.$row->kode_modul,
										'<div class="on-default edit-row"><i class="fa fa-pencil"></i></div>');
										?>
									</td>
									<td>
										<?php echo anchor('/c_admin/hps_modul/'.$row->kode_modul,
