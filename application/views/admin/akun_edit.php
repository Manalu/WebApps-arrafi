		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="card-box">
					<br>
						<form class="form-horizontal" role="form" method="post" action="<?php echo base_url()?>c_admin/update_user" onsubmit="return validasi(this);">
						<?php
							...
							<div class="form-group">
								...
								<?php echo anchor('/c_admin/get_user_pass/'.$row->username,
