                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                          <?php echo $_GET['nama']; ?>, Saat Ini Kelas <?php echo $_GET['kelas']; ?>  
						   <a style="float:right;" href="<?php echo base_url()?>index.php/ortu/info_pilih_siswa"> <button type="button" class="btn btn-warning">Menu Siswa</button></a>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table-responsive">
							<div style="width: 200px; height: 50px;">
							<form role="form" action="<?php echo base_url()?>index.php/ortu/info_pilih_mapel?nis=<?php echo $_GET['nis']; ?>&nama=<?php echo $_GET['nama']; ?>&kelas=<?php echo $_GET['kelas']; ?>&thnajar=x&semester=" method='post' enctype='multipart/form-data'>
						  ...
						  ?></b> 
							...
							<div style="width: 200px; height: 50px;">
							<form role="form" action="<?php echo base_url()?>index.php/ortu/info_pilih_mapel?nis=<?php echo $_GET['nis']; ?>&kelas=<?php echo $_GET['kelas']; ?>&nama=<?php echo $_GET['nama']; ?>&semester=x&thnajar=
							<?php 
						  if ($_GET['thnajar'] != null and $_GET['thnajar'] != "x"){
						  echo $_GET['thnajar']; 
						  }
						  ...
						  ?></b> 
							...
							<?php foreach($list->result() as $row){ ?>
								<div style="margin:auto; border-radius:50px; height:50px; display:block;">
                                	<a href="<?php echo base_url()?>index.php/ortu/info_detil_nilai?nis=<?php echo $_GET['nis']; ?>&nama=<?php echo $_GET['nama']; ?>&kelas=<?php echo $_GET['kelas']; ?>&semester=<?php 
									if ($_GET['semester'] != null and $_GET['semester'] != "x"){
										echo $_GET['semester']; 
									}
									else{
