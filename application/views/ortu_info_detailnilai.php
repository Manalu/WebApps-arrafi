                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                          Nama <?php echo $_GET['nama']; ?>, Pelajaran <?php echo $_GET['namamapel']; ?>, Semester <?php echo $_GET['semester']; ?>   
						    <a style="float:right;" href="<?php echo base_url()?>index.php/ortu/info_pilih_mapel?nis=<?php echo $_GET['nis']; ?>&nama=<?php echo $_GET['nama']; ?>&kelas=<?php echo $_GET['kelas']; ?>&semester=<?php echo $_GET['semester']; ?>&thnajar=<?php echo $_GET['thnajar']; ?>"> <button type="button" class="btn btn-success">Menu Mata Pelajaran</button></a>
                        </div>
                        <!-- /.panel-heading -->
