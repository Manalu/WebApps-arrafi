                        ...
                        <div class="panel-body">
							...
							<?php foreach($list->result() as $row){ ?>
                                 <div style="margin:auto; float:left; border-radius: 50px; width:150px; display:inline;">
                                    <a href="<?php echo base_url()?>index.php/ortu/info_pilih_mapel?nis=<?php echo $row->nis; ?>&nama=<?php echo $row->nama; ?>&kelas=<?php echo $row->kelas; ?>&semester=&thnajar="><img src='<?php echo base_url();?>logo/
									<?php if($row->jk=='L'){
									echo "cowo2.png";
									}
									else {
