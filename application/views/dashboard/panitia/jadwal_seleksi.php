                                                    ...
                                                    <td>
                                                     ...
                                                     <span></span></a>
                                                        <?php
                                                            ...
                                                            echo anchor('Registrasi_C/hapus_jadwal_seleksi/'.$value->id_jadwal,' <i style="color:#f05050" class="fa fa-trash-o fa-2x fa-fw"></i> <span></span> ', $attributes);
                                                        ?>
                                                    </td>
                                                </tr>
                                                    <?php
...
<!-- Ubah Jadwal Seleksi -->
<!-- ============================================================== -->
                <div id="edit_jadwal_waktu" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                    <div class="modal-dialog"> 
                        <div class="modal-content">
                            <?php
                                $attributes = array(
                                            ...
                                            <div class="col-sm-8">
                                                <div class="input-group">
                                                    <select class="selectpicker" data-style="btn-white" name="status">
                                                        <option value="Status" selected="true" disabled="true">Status</option>
                                                        <option value="Terlaksana">Terlaksana</option>
                                                        <option value="Berlangsung">Berlangsung</option>
                                                        <option value="Belum">Belum</option>
                                                    </select>
