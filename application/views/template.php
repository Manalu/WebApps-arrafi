							...
							<?php } ?>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li>
											<a href="<?php echo base_url('c_login/doLogout');?>">
				...
				<div class="sidebar-inner slimscrollleft">
					...
					<div id="sidebar-menu">
						<ul>
							...
							<li>
								<a href="<?php echo base_url('c_home/get_profil');?>" class="waves-effect">
									<i class="icon-user"></i> <span> Ubah Password </span>
								</a>
							</li>

							<?php if ($this->session->userdata('kode_group') == 1) { ?>
							<li>
								<a href="<?php echo base_url('c_admin/data_user');?>" class="waves-effect">
									<i class="icon-people"></i> <span> Kelola User </span>
								</a>
							</li>

							<li>
								<a href="<?php echo base_url('c_admin/data_modul');?>" class="waves-effect">
									<i class="ti-harddrives"></i> <span> Kelola Modul </span>
								</a>
							</li>

							<li>
								<a href="<?php echo base_url('c_admin/data_grup');?>" class="waves-effect">
									<i class="ti-lock"></i><span> Kelola Otoritas </span>
								</a>
							</li>
							<?php } ?>
							...
							<li>
								<a href="<?php echo base_url($row->link);?>" class="waves-effect">
									<i class="ti-harddrive"></i><span><?php echo ' '.$row->nama_modul;?></span>
								</a>
							</li>
							<?php } ?>
						</ul>
